...
<kul:innerTab tabTitle="${trunGroupName}"
					 tabErrorKey="${tabErrorKeys[groups.groupName]}"
					 auditCluster="ynqAuditErrors${fullGroupName}" 
					 tabAuditKey="${tabErrorKeys[groups.groupName]}" 
			         tabDescription=""
			         defaultOpen="true"
